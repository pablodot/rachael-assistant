...
class LLMClient:
    ...
    async def get_plan_json(self, user_message: str) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            "IMPORTANTE: 'el país' y 'elpais' son SIEMPRE https://www.elpais.com (diario El País, NO público.es)\n"
            "IMPORTANTE: 'el mundo' es SIEMPRE https://www.elmundo.es\n\n"

            "# Prensa española\n"
            "- 'el pais', 'elpais', 'el país', 'país' → https://www.elpais.com  ← diario El País\n"
            "- 'el mundo', 'elmundo' → https://www.elmundo.es\n"
            ...
            "- 'publico', 'público' → https://www.publico.es  ← diario Público (distinto de El País)\n"

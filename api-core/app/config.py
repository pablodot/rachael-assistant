...
class Settings(BaseSettings):
    ...
    # Modelo de embeddings (Ollama nomic-embed-text → 768 dims)
    ...
    database_url: str = "postgresql://rachael:rachael@memory-db:5432/rachael"

    # Qdrant (vector-store)
    qdrant_url: str = "http://vector-store:6333"
